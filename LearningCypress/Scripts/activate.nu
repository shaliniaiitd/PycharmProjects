...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Shalini_Agarwal\PycharmProjects\Cypress_API'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Shalini_Agarwal\PycharmProjects\Cypress_API\Scripts\deactivate.nu'
