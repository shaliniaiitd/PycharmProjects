        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (!isLegacy)
                    ...
                    return [2 /*return*/, this.getData("".concat(this.legacyBaseUrl).concat(apiEndpoint))];
                return [2 /*return*/];
            });
        });
    };
    ...
    NseIndia.prototype.getIndexHistoricalData = function (index, range) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        dateRanges = (0, utils_1.getDateRangeChunks)(range.start, range.end, 360);
                        promises = dateRanges.map(function (dateRange) { return __awaiter(_this, void 0, void 0, function () {
                                ...
                                switch (_a.label) {
                                    case 0:
                                        endpoint = '/products/dynaContent/equities/indices/historicalindices.jsp' +
                                            "?indexType=".concat(encodeURIComponent(index
                                                .toUpperCase()), "&fromDate=").concat(dateRange.start, "&toDate=").concat(dateRange.end);
                                    ...
                                    case 1:
                                        ...
                                        historicalRecords.forEach(function (record, i) {
                                            if (record && i > 0) {
                                                ...
                                                historical.push({
                                                    date: new Date("".concat(date, " 17:30:00 GMT+0530")),
                                                    open: Number(open_1),
                                                    high: Number(high),
                                                    low: Number(low),
